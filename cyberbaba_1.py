...
try:
    ...
    pass
prox = open('https://github.com/Pro-Max-420/ua/blob/main/bbnew.txt').read().splitlines()
...
def uaku():
    try:
        ua = open('https://github.com/Pro-Max-420/ua/blob/main/bbnew.txt').read().splitlines()
        for ub in ua:
            ugen.append(ub)
    except:
